...
Vtiger_Index_Js("Vtiger_Edit_Js",{
    ...
    */
	...
	registerEventLeadsOppChangeEvent : function() {
		jQuery('#Leads_editView_fieldName_appliances').on('change', function(){
			var appliances = jQuery('#Leads_editView_fieldName_appliances').is(":checked");
			if(appliances == true){
				jQuery('#Leads_editView_fieldName_hob').show();
				jQuery('#Leads_editView_fieldName_hob').closest('td').prev().show();
				jQuery('#Leads_editView_fieldName_hob').closest('td').show();

				jQuery('#Leads_editView_fieldName_chimney').show();
				jQuery('#Leads_editView_fieldName_chimney').closest('td').prev().show();
				jQuery('#Leads_editView_fieldName_chimney').closest('td').show();

				jQuery('#Leads_editView_fieldName_microwave').show();
				jQuery('#Leads_editView_fieldName_microwave').closest('td').prev().show();
				jQuery('#Leads_editView_fieldName_microwave').closest('td').show();

				jQuery('#Leads_editView_fieldName_oven').show();
				jQuery('#Leads_editView_fieldName_oven').closest('td').prev().show();
				jQuery('#Leads_editView_fieldName_oven').closest('td').show();

				jQuery('#Leads_editView_fieldName_dishwasher').show();
				jQuery('#Leads_editView_fieldName_dishwasher').closest('td').prev().show();
				jQuery('#Leads_editView_fieldName_dishwasher').closest('td').show();

				jQuery('#Leads_editView_fieldName_coffeemaker').show();
				jQuery('#Leads_editView_fieldName_coffeemaker').closest('td').prev().show();
				jQuery('#Leads_editView_fieldName_coffeemaker').closest('td').show();
			}else{
				jQuery('#Leads_editView_fieldName_hob').hide();
				jQuery('#Leads_editView_fieldName_hob').closest('td').prev().hide();
				jQuery('#Leads_editView_fieldName_hob').closest('td').hide();

				jQuery('#Leads_editView_fieldName_chimney').hide();
				jQuery('#Leads_editView_fieldName_chimney').closest('td').prev().hide();
				jQuery('#Leads_editView_fieldName_chimney').closest('td').hide();

				jQuery('#Leads_editView_fieldName_microwave').hide();
				jQuery('#Leads_editView_fieldName_microwave').closest('td').prev().hide();
				jQuery('#Leads_editView_fieldName_microwave').closest('td').hide();

				jQuery('#Leads_editView_fieldName_oven').hide();
				jQuery('#Leads_editView_fieldName_oven').closest('td').prev().hide();
				jQuery('#Leads_editView_fieldName_oven').closest('td').hide();

				jQuery('#Leads_editView_fieldName_dishwasher').hide();
				jQuery('#Leads_editView_fieldName_dishwasher').closest('td').prev().hide();
				jQuery('#Leads_editView_fieldName_dishwasher').closest('td').hide();

				jQuery('#Leads_editView_fieldName_coffeemaker').hide();
				jQuery('#Leads_editView_fieldName_coffeemaker').closest('td').prev().hide();
				jQuery('#Leads_editView_fieldName_coffeemaker').closest('td').hide();
			}
		});

		jQuery('#Leads_editView_fieldName_appliances').trigger('change');

		jQuery('#Potentials_editView_fieldName_appliances').on('change', function(){
			var appliances = jQuery('#Potentials_editView_fieldName_appliances').is(":checked");
			if(appliances == true){
				jQuery('#Potentials_editView_fieldName_hob').show();
				jQuery('#Potentials_editView_fieldName_hob').closest('td').prev().show();
				jQuery('#Potentials_editView_fieldName_hob').closest('td').show();

				jQuery('#Potentials_editView_fieldName_chimney').show();
				jQuery('#Potentials_editView_fieldName_chimney').closest('td').prev().show();
				jQuery('#Potentials_editView_fieldName_chimney').closest('td').show();

				jQuery('#Potentials_editView_fieldName_microwave').show();
				jQuery('#Potentials_editView_fieldName_microwave').closest('td').prev().show();
				jQuery('#Potentials_editView_fieldName_microwave').closest('td').show();

				jQuery('#Potentials_editView_fieldName_oven').show();
				jQuery('#Potentials_editView_fieldName_oven').closest('td').prev().show();
				jQuery('#Potentials_editView_fieldName_oven').closest('td').show();

				jQuery('#Potentials_editView_fieldName_dishwasher').show();
				jQuery('#Potentials_editView_fieldName_dishwasher').closest('td').prev().show();
				jQuery('#Potentials_editView_fieldName_dishwasher').closest('td').show();

				jQuery('#Potentials_editView_fieldName_coffeemaker').show();
				jQuery('#Potentials_editView_fieldName_coffeemaker').closest('td').prev().show();
				jQuery('#Potentials_editView_fieldName_coffeemaker').closest('td').show();
			}else{
				jQuery('#Potentials_editView_fieldName_hob').hide();
				jQuery('#Potentials_editView_fieldName_hob').closest('td').prev().hide();
				jQuery('#Potentials_editView_fieldName_hob').closest('td').hide();

				jQuery('#Potentials_editView_fieldName_chimney').hide();
				jQuery('#Potentials_editView_fieldName_chimney').closest('td').prev().hide();
				jQuery('#Potentials_editView_fieldName_chimney').closest('td').hide();

				jQuery('#Potentials_editView_fieldName_microwave').hide();
				jQuery('#Potentials_editView_fieldName_microwave').closest('td').prev().hide();
				jQuery('#Potentials_editView_fieldName_microwave').closest('td').hide();

				jQuery('#Potentials_editView_fieldName_oven').hide();
				jQuery('#Potentials_editView_fieldName_oven').closest('td').prev().hide();
				jQuery('#Potentials_editView_fieldName_oven').closest('td').hide();

				jQuery('#Potentials_editView_fieldName_dishwasher').hide();
				jQuery('#Potentials_editView_fieldName_dishwasher').closest('td').prev().hide();
				jQuery('#Potentials_editView_fieldName_dishwasher').closest('td').hide();

				jQuery('#Potentials_editView_fieldName_coffeemaker').hide();
				jQuery('#Potentials_editView_fieldName_coffeemaker').closest('td').prev().hide();
				jQuery('#Potentials_editView_fieldName_coffeemaker').closest('td').hide();
			}
		});

		jQuery('#Potentials_editView_fieldName_appliances').trigger('change');
	},
    ...
    registerEvents: function(callParent) {
		...
		this.registerEventLeadsOppChangeEvent();
    }
});
