...
<div id="2Dattachment" class='modal-xs modal-dialog'>
    <div class = "modal-content">
        {assign var=TITLE value="{vtranslate('3D Design Attachment', $MODULE)}"}
        ...
        <form class="form-horizontal" id="massSave" method="post" action="index.php" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div>
                    <span><strong>{vtranslate('Select 3D Design Attachment',$MODULE)}</strong></span>
                    &nbsp;:&nbsp;<br><br>
                    <div>
            ...
            <div>
                <div class="modal-footer">
                    <center>
                        <button class="btn btn-success" type="save3DDesign"><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>
