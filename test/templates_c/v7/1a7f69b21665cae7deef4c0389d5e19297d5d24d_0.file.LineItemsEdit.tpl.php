<?php
/* Smarty version 3.1.39, created on 2024-03-15 07:15:37
  from 'C:\xampp\htdocs\innca\layouts\v7\modules\Inventory\partials\LineItemsEdit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_65f3f5995742d0_63011171',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1a7f69b21665cae7deef4c0389d5e19297d5d24d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\innca\\layouts\\v7\\modules\\Inventory\\partials\\LineItemsEdit.tpl',
      1 => 1710403179,
      2 => 'file',
    ),
  ),
...
function content_65f3f5995742d0_63011171 (Smarty_Internal_Template $_smarty_tpl) {
...
</strong></td><!-- New Changes Opp Module --><td><strong><?php echo vtranslate('LBL_CTGRY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><!-- New Changes Opp Module --><?php if ((isset($_smarty_tpl->tpl_vars['IMAGE_EDITABLE']->value))) {?><td><strong><?php ob_start();
...
</strong></td><?php }?><td><strong><?php echo vtranslate('LBL_unitss',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><td><strong><?php echo vtranslate('LBL_finish_varients',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><td><strong><?php echo vtranslate('LBL_length',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><td><strong><?php echo vtranslate('LBL_height',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><td><strong><?php echo vtranslate('LBL_QTY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><td><strong><?php echo vtranslate('LBL_rate_sft',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><td><strong><?php echo vtranslate('LBL_finish_sft',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><td><strong><?php echo vtranslate('LBL_total_sft',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></td><td><strong><?php echo vtranslate('LBL_unit_amount',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></td><?php }?></tr><tr id="row0" class="hide lineItemCloneCopy" data-row-num="0"><?php $_smarty_tpl->_subTemplateRender(vtemplate_path("partials/LineItemsContent.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('row_no'=>0,'data'=>array(),'IGNORE_UI_REGISTRATION'=>true), 0, true);
?></tr><?php
...
} else { ?>0<?php }?>"></span></td></tr><tr valign="top"><td width="83%"><span class="pull-right 1"><strong><?php echo vtranslate('LBL_GRAND_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span></td></tr><?php if ($_smarty_tpl->tpl_vars['MODULE']->value != 'SalesOrder') {?><tr valign="top"><td width="83%" ><div class="pull-right"><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Invoice' || $_smarty_tpl->tpl_vars['MODULE']->value == 'Quotes') {?><strong><?php echo vtranslate('LBL_RECEIVED',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong><?php } else { ?><strong><?php echo vtranslate('LBL_PAID',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong><?php }?></div></td><td><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Invoice' || $_smarty_tpl->tpl_vars['MODULE']->value == 'Quotes') {?><span class="pull-right"><input id="received" name="received" type="text" class="lineItemInputBox form-control" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('received') && !($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)) {
echo $_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('received');
} else { ?>0<?php }?>" readonly></span><?php } else { ?><span class="pull-right"><input id="paid" name="paid" type="text" class="lineItemInputBox" value="<?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getDisplayValue('paid') && !($_smarty_tpl->tpl_vars['IS_DUPLICATE']->value)) {
