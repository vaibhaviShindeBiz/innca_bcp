<?php
/* Smarty version 3.1.39, created on 2024-01-12 06:14:24
  from 'C:\wamp64\www\Innca\layouts\v7\modules\Leads\ModuleRelatedTabs.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_65a0d8c00f9bf7_99751145',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '81768f6924ed9aed52a0875a8b0a063d8df9c102' => 
    array (
      0 => 'C:\\wamp64\\www\\Innca\\layouts\\v7\\modules\\Leads\\ModuleRelatedTabs.tpl',
      1 => 1704370213,
      2 => 'file',
    ),
  ),
...
function content_65a0d8c00f9bf7_99751145 (Smarty_Internal_Template $_smarty_tpl) {
?><div class='related-tabs row'><nav class="navbar margin0" role="navigation"><div class="navbar-header"><button type="button" class="navbar-toggle btn-group-justified collapsed border0" data-toggle="collapse" data-target="#nav-tabs" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></button></div><div class="progress "><div class="circle <?php if ($_smarty_tpl->tpl_vars['follow1st']->value == '1') {?> active <?php }?>"><span class="label">✓</span><span class="title" title="1st follow">1st follow</span></div><span class="bar done"></span><div class="circle <?php if ($_smarty_tpl->tpl_vars['follow2nd']->value == '1') {?> active <?php }?>"><span class="label">✓</span><span class="title" title="2nd follow">2nd follow</span></div><span class="bar done"></span><div class="circle <?php if ($_smarty_tpl->tpl_vars['follow3rd']->value == '1') {?> active <?php }?>"><span class="label">✓</span><span class="title" title="3rd follow">3rd follow</span></div></div><div class="collapse navbar-collapse" id="nav-tabs"><ul class="nav nav-tabs"><?php
