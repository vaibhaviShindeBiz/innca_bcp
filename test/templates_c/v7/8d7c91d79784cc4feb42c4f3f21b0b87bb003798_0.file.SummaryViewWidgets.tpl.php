<?php
/* Smarty version 3.1.39, created on 2024-01-04 12:08:01
  from 'C:\wamp64\www\Innca\layouts\v7\modules\Leads\SummaryViewWidgets.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_65969fa118e5d1_90216459',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8d7c91d79784cc4feb42c4f3f21b0b87bb003798' => 
    array (
      0 => 'C:\\wamp64\\www\\Innca\\layouts\\v7\\modules\\Leads\\SummaryViewWidgets.tpl',
      1 => 1704370054,
      2 => 'file',
    ),
  ),
...
function content_65969fa118e5d1_90216459 (Smarty_Internal_Template $_smarty_tpl) {
...
</h4></div><div class="widget_contents"></div></div></div><?php }?></div><div class="middle-block col-lg-8"><div class="summaryWidgetContainer"><div class="widgetContainer_comments"><div class="widget_header"><h4 class="display-inline-block">Followup</h4></div><br><br><div class="widget_contents1"><table class="class="table table-borderless""><tr><td><input type="checkbox" name="1stfollow" id="1stfollow" <?php if ($_smarty_tpl->tpl_vars['follow1st']->value == '1') {?> checked <?php }?>> 1st Follow<br><br><td><tr><tr><td><input type="checkbox" name=2ndfollow" id="2ndfollow" <?php if ($_smarty_tpl->tpl_vars['follow2nd']->value == '1') {?> checked <?php }?>> 2nd Follow<br><br><td><tr><tr><td><input type="checkbox" name="3rdfollow" id="3rdfollow" <?php if ($_smarty_tpl->tpl_vars['follow3rd']->value == '1') {?> checked <?php }?>> 3rd Follow<br><br><td><tr></table></div></div></div></div><?php }
}
