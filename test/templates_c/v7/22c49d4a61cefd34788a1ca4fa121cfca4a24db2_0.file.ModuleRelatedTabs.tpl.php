<?php
/* Smarty version 3.1.39, created on 2024-01-05 04:05:05
  from 'C:\wamp64\www\Innca\layouts\v7\modules\Potentials\ModuleRelatedTabs.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_65977ff1d321f2_24327190',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '22c49d4a61cefd34788a1ca4fa121cfca4a24db2' => 
    array (
      0 => 'C:\\wamp64\\www\\Innca\\layouts\\v7\\modules\\Potentials\\ModuleRelatedTabs.tpl',
      1 => 1704427502,
      2 => 'file',
    ),
  ),
...
function content_65977ff1d321f2_24327190 (Smarty_Internal_Template $_smarty_tpl) {
?><div class='related-tabs row'><nav class="navbar margin0" role="navigation"><div class="navbar-header"><button type="button" class="navbar-toggle btn-group-justified collapsed border0" data-toggle="collapse" data-target="#nav-tabs" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></button></div><div class="progress "><div class="circle <?php if ($_smarty_tpl->tpl_vars['advancePayment']->value == '1') {?> active <?php }?>"><span class="label">✓</span><span class="title" title="1st follow">Advance Payment</span></div><span class="bar done"></span><div class="circle <?php if ($_smarty_tpl->tpl_vars['quotesReady']->value == '1') {?> active <?php }?>"><span class="label">✓</span><span class="title" title="2nd follow">Quotes Ready</span></div><span class="bar done"></span><div class="circle <?php if ($_smarty_tpl->tpl_vars['siteVisit']->value == '1') {?> active <?php }?>"><span class="label">✓</span><span class="title" title="3rd follow">Site Visit</span></div><span class="bar done"></span><div class="circle <?php if ($_smarty_tpl->tpl_vars['design2d']->value == '1') {?> active <?php }?>"><span class="label">✓</span><span class="title" title="3rd follow">2D design</span></div><span class="bar done"></span><div class="circle <?php if ($_smarty_tpl->tpl_vars['design3d']->value == '1') {?> active <?php }?>"><span class="label">✓</span><span class="title" title="3rd follow">3D design</span></div></div><div class="collapse navbar-collapse" id="nav-tabs"><ul class="nav nav-tabs"><?php
