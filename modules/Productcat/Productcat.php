...
class Productcat extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_productcat';
	var $table_index= 'productcatid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_productcatcf', 'productcatid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_productcat', 'vtiger_productcatcf');
	...
	var $related_tables = Array( 
					'vtiger_productcatcf' => Array('productcatid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_productcat'   => 'productcatid',
	    'vtiger_productcatcf' => 'productcatid');
	...
	var $list_fields = Array (
		...
		'Productcat No' => Array('productcat', 'productcatno'),
/*'Productcat No'=> Array('productcat', 'productcatno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Productcat No' => 'productcatno',
/*'Productcat No'=> 'productcatno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'productcatno';
...
/*'Productcat No'=> 'productcatno',*/
	...
	var $popup_fields = Array ('productcatno');

	// For Alphabetical search
	var $def_basicsearch_col = 'productcatno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'productcatno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('productcatno','assigned_user_id');

	var $default_order_by = 'productcatno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Productcat::checkWebServiceEntry();
			Productcat::createUserFieldTable($moduleName);
			Productcat::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Productcat'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Productcat','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
